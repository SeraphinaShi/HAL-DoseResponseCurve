# This file downloaded from https://github.com/ehkennedy/npcausal/blob/master/R/ctseff.R, with some minot midification
...
#'
ctseff <- function(y, a, x, bw.seq, eval_points,
