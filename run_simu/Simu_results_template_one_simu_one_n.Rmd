...
results_grid_s$oracal_MSE = results_grid_s$bias^2 + results_grid_s$oracal_SE^2
...
results_grid_extra$result_summary = add_bound(results_grid_extra$result_summary)
results_grid_extra$result_summary$method[results_grid_extra$method == "U_G"] = "Undersmooth"

results_grid_all <- results_grid_extra$result_summary

results_grid_all$MSE = results_grid_all$bias^2 + results_grid_all$SE^2
results_grid_all$oracal_MSE = results_grid_all$bias^2 + results_grid_all$oracal_SE^2
