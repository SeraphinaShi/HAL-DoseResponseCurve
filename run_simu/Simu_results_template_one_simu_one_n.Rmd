...
results_gam$MSE = results_gam$bias^2 + results_gam$oracle_SE^2
results_poly$MSE = results_poly$bias^2 + results_poly$oracle_SE^2
results_npcausal$MSE = results_npcausal$bias^2 + results_npcausal$oracle_SE^2
...
results_all$MSE = results_all$bias^2 + results_all$oracle_SE^2
```
